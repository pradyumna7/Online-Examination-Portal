...
$studentsection = $_SESSION['student_section'];
			 ...
			 <div class="row  margin-top-50 right">
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 left" style="min-height: 1px;">
                        ...
                        ?>
		                    ...
		                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 left" style="min-height: 1px;">
	
        <form method="post">
           <input type="submit" name="AAA" value="Advanced Analysis of Algorithims" style="padding:20px;margin:10px;border:1px solid black; width:300px">
              <input type="submit" name="APL" value="Advanced Programming Languages" style="padding:20px;margin:10px;border:1px solid black;width:300px" > 
            <input type="submit" name="ASE" value="Advanced Software Engineering" style="padding:20px;margin:10px;border:1px solid black;width:300px">  
        </form>
                                    </div>			
		</div>
...
<?php
if (isset($_POST['AAA'])) {
    $_SESSION['subbro'] = "AAA";echo "<script type='text/javascript'> document.location = '22.php'; </script>";
}
if (isset($_POST['APL'])) {
    $_SESSION['subbro'] = "APL";echo "<script type='text/javascript'> document.location = '22.php'; </script>";
}
if (isset($_POST['ASE'])) {
    $_SESSION['subbro'] = "ASE";echo "<script type='text/javascript'> document.location = '22.php'; </script>";
}
