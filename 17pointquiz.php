...
$querys = "Select * from quiz_questions where assignment_no='$testno'";
	...
	<div class="container">
		...
		<div class="row margin-top-20">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-7" style="min-height: 1px;">
					...
					<h3>
						Selected examination type is : QUIZ
					</h3>
					<p>
...
<script type="text/JavaScript">
      setTimeout("location.href = '11.php';",30000);
 </script>
<script>

function openWin() {
 window.open("18.php", "_blank", "channelmode=yes");
