    ...
    MediumEditor.prototype = {
        ...
        execAction: function (action, e) {
            if (action.indexOf('append-') > -1) {
                if (action.indexOf('blockquote') > -1) {
              ...
              //  this.triggerAnchorAction(e);
                ...
                if (isBlockquote && selectionData.el.tagName === 'P') {
                    $(selectionData.el).children().unwrap('p');
            }
        },
        ...
        bindAnchorForm: function () {
            ...
            this.anchorInput.addEventListener('mousedown', function (e) {
        ...
        createLink: function (input) {
            ...
            this.savedSelection[0].endContainer.href = input.value;
            this.hideToolbarActions();
        ...
        cleanPaste: function (text) {
            ...
            */
            ...
            if (multiline) {
                ...
                elList = el.querySelectorAll('p,div,br,h1,h2,h3');
