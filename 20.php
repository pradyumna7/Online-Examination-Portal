...
$testn = $_SESSION['pdf_question'];
$testno=$testn;
    require "connection_server.php";
    $query = "Select * from pdf_questions where test_no='$testno';";
...
<section style="display: block;">
	<div class="container">
		...
		<div class="row margin-top-20">
			...
			</p><input type="file" name="ppt" /><br /><br />
		</div>
		<div class="row margin-top-20 text-center">
...
$sql = "INSERT INTO pdf_answers (id,type,subject,branch,section,test_no,assignment_no,ans_1)"
                       .  "VALUES ('$studentid','pdf','$subject','cse','b',$testno,1,'$ppt')";
              $result = $mysqli->query($sql);
                 $fid=$row["id"];
                $sqll = "INSERT INTO all_tests (student_id,faculty_id,type,subject,test_no)"
                       .  "VALUES ('$studentid','$fid','pdf','$subject','$testno')";
