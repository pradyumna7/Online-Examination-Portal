...
<section style="display: block;">
	<div class="container">
            <h1>welcome <?php echo $rows["name"] ?></h1><h2> <?php echo "subject-" . $rows["subject"] ?></h2>
        ...
        if (isset($_POST['logout'])) {
            ...
            unset($_SESSION['faculty_subject']);
		...
		<div class="row  margin-top-50">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="min-height: 1px;">
				<div class="thumbnail">
					<img class="img-responsive" src="photi/ed.jpg" alt="" />
                                ...
                                <a style="text-decoration:none" href="26.php"><button style="padding:20px;margin:10px;border:1px solid black; width:270px" type="button">CREATE A TEST</button></a>
                                <a style="text-decoration:none"href="27.php"><button style="padding:20px;margin:10px;border:1px solid black; width:270px"type="button">CREATE A NOTIFICATION</button></a>
                                <a style="text-decoration:none"href="28.php"><button style="padding:20px;margin:10px;border:1px solid black; width:270px"type="button">UPLOAD DOCUMENTS</button></a>
                                <a style="text-decoration:none"href="32.php"><button style="padding:20px;margin:10px;border:1px solid black; width:270px"type="button">CORRECTION</button></a>
