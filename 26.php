...
<section style="display: block;">
    ...
    <a style="text-decoration:none;" href="29.php"><button style="padding:20px;margin:10px;border:1px solid black; width:270px" type="button">Theory Exam</button></a><br>
   <!-- <a style="text-decoration:none;" href="31.php"><button style="padding:20px;margin:10px;border:1px solid black; width:270px" type="button">PPT Exam</button></a><bR>
   --> <a style="text-decoration:none;" href="30.php"><button style="padding:20px;margin:10px;border:1px solid black; width:270px" type="button">Quiz Exam</button></a><br>
 ...
 <footer class="section-dark sticky-footerbox-layer" style="display: block; margin-top: 5%;padding: 0px;">
            <div class="container">
