...
<section style="display: block;">
	<div class="container">
		...
		<div class="row col-xs-12 col-sm-5 col-md-5 col-lg-5 margin-top-20">
                    <form action="27.php" method="post">
            <h2> Notification </h2>
            <h4>  TITLE </h4><br> <input  style="height:50px;width:400px;margin-bottom:20px" type="text" name="title" required><br>
            <h4>NOTIFICATION </h4><br> <input  style="height:50px;width:400px;margin-bottom:20px" type="text" name="notifi" required> <br>
               <input style="height:50px;width:200px;background-color: #4CAF50;" type="submit" name="submit">
        </form>
                </div>	
			<div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 margin-top-50" style="margin-left:200px;min-height: 1px;">
...
$title = $_POST["title"];
$notifi = $_POST["notifi"];
            $sql = "INSERT INTO notifications (id,title,notification,branch)"
                       .  "VALUES ('$facultyid','$title','$notifi','cse')";
              $result = $mysqli->query($sql);
                 if ($result){
                    echo "<script type='text/javascript'>  window.alert('notification posted')      
 document.location = '25.php'; </script>";
                }
                else
                    {
                  echo "<h1>notification cant be posted</h1>";
                }
