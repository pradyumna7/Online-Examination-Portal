...
$testno = $_SESSION['pdf_question'];
$_SESSION['ass_no']=$ass_no;
$_SESSION['subb']=$subb;
require "connection_server.php";
$querys = "Select * from pdf_questions where test_no='$testno'";
	...
	<div class="container">
		...
		<div class="row margin-top-20">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-7" style="min-height: 1px;">
                                ...
                                <h1><?php echo "Subject=$subb"?></h1>
                                <h1><?php echo "Assignment=$ass_no"?></h1>
                                

				<form>
					<h3>
						Selected examination type is : PPT
					</h3>
					<p>
					...
					<p>
						PowerPoint is similar to a word processor, except that it's geared toward creating presentations rather than documents. PowerPoint presentations consist of one or more slides. Each slide can contain text, graphics, and other information.
					</p><br /><br /> RULES FOR PPT :
					<ul>
						<li>
						...
						<li>
							Vary Your Format
                                        ...
                                        DEAD LINE : <p><?php echo $rows["deadline"]?> </p>
...
function openWin() {
 window.open("20.php", "_blank", "channelmode=yes,fullscreen=yes");
