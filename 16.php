...
$sql = "INSERT INTO doubt_questions (post_no,id,branch,section,professor,doubt)"
                       .  "VALUES (1,'$studentid','cse','$studentsection','$pro','$que')";
              $result = $mysqli->query($sql);
                 if ($result){
                      echo "<script type='text/javascript'>  window.alert('doubt sent successful!')      
 document.location = '11.php'; </script>";
                }
                else
                    {
                  echo "<h1>doubt cant be sent</h1>";
                }
