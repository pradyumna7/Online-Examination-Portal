...
$query = "Select * from theory_questions where assignment_no='$asss' and subject='$subbb'";
		...
		<div class="row margin-top-20">
			<form action="19.php" method="post" >
                            ...
                            <input style="height:0px;width:0px;border:none;color:white" type="text" name="an" value="<?php echo $asss?>"/>
                             ...
                             <h3>
					1.<?php echo $row["question_1"] ?>
				</h3><input style="height:100px;width:50%" type="text" name="answer1" />
				<h3>
					2.<?php echo $row["question_2"] ?>
				</h3><input style="height:100px;width:50%;margin-bottom:10px;" type="text" name="answer2" /><br><input class="btn btn-info btn-lg" type="submit" value="Submit!" /><br />
			</form>
 ...
 $sql = "INSERT INTO theory_answers (id,type,subject,branch,section,assignment_no,ans_1,ans_2)"
    ...
    $result = $mysqli->query($sql);
     ...
     $sqll = "INSERT INTO all_tests (student_id,faculty_id,type,subject,assignment_no)"
                       .  "VALUES ('$studentid','$fiddd','theory','$subbb','$asss')";
