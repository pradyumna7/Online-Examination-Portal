		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse1">
				<ul class="nav navbar-nav navbar-right">
					...
					<li>
						 <a href="3.html">COURSES</a>
					</li>
					<li>
						 <a href="4.html">FORUM</a>
					</li>
					<li>
						 <a href="7.php">CONTACT US</a>
					</li>
					<li>
...
<section style="display: block;">
 ...
 <form action="24.php" method="post" >
  IMAGE: <input type="file"             name="image" id="fileToUpload"><br>
  ...
  DOB: <input type="text"               name="dob"          value="<?php echo $row["dob"] ?>" required><br>
  FATHER NAME: <input type="text"       name="father"       value="<?php echo $row["father_name"] ?>" required><br>
  GENDER: <input type="text"            name="gender"       value="<?php echo $row["gender"] ?>" required><br>
  PHONE NUMBER: <input type="text"      name="phone"        value="<?php echo $row["phone_number"] ?>" required><br>
  ALTERNATE NUMBER: <input type="text"  name="alternate"    value="<?php echo $row["phone_number2"] ?>" required><br>
  EMAIL ID: <input type="text"          name="email"        value="<?php echo $row["email_id"] ?>" required><br>
  PASSWORD: <input type="text"          name="password"     value="<?php echo $row["password"] ?>" required><br>
  CONFIRM PASSWORD: <input type="text"  name="cpassword"    value="<?php echo $row["password"] ?>" required><br>
  SECURITY QUESTION 1:<input type="text" name="sq1"         value="<?php echo $row["security_question1"] ?>" required><br>
  SECURITY ANSWER 2:<input type="text"  name="sa1"          value="<?php echo $row["security_answer1"] ?>" required><br>
  SECURITY QUESTION 1:<input type="text" name="sq2"         value="<?php echo $row["security_question2"] ?>" required><br>
  SECURITY ANSWER 2:<input type="text"  name="sa2"          value="<?php echo $row["security_answer2"] ?>" required><br>

  
  <input type="submit" value="UPDATE">
  </form>

        <a href="11.php"><button value="back" name="back" >
      BACK
            </button></a>
...
$sa2 = $_POST["sa2"];
                ...
                $qur = "UPDATE student SET name='$name',branch='$branch',section='$section',dob='$dob',
                        father_name='$father',gender='$gender',phone_number='$phone',phone_number2='$alternate',email_id='$email',
                            password='$password',security_question1='$sq1',security_answer1='$sa1',security_question2='$sq2',
                       security_answer2='$sa2' WHERE id='1' ";
                
                $result = $mysqli->query($qur);
                 if ($result){
                    echo "<script type='text/javascript'>  window.alert('Registration successful! Updated the database')      
 document.location = '11.php'; </script>";
                }
                else {
                  echo "<h1>database could not be updated</h1>";
                }
