			...
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-7" style="min-height: 1px;">
				...
				<title>
				 ...
				 <form action="29.php" method="post">
                                     <h3>1. Assignment Number </h3>
        <input style="height:50px;width:400px;" type="int" name="assno" required>
        <h3>2. Question </h3>
        <input style="height:50px;width:400px;" type="text" name="question1" required>
        <h3>3. Question </h3>
        <input style="height:50px;width:400px;" type="text" name="question2" required>
          <h3>4. Time limit</h3>
          <input  style="height:50px;width:400px;margin-bottom:20px" type="int" name="time2" required><br>
        <input style="height:50px;width:200px;background-color: #4CAF50;"type="submit" value="Submit"><br>
        </form>
...
$subject =$rows["subject"];
         $sql = "INSERT INTO theory_questions (id,type,subject,branch,assignment_no,question_1,question_2,time_limit_2)"
                       .  "VALUES ('$facultyid','theory','$subject','cse',$number,'$q1','$q2',$t2)";
              $result = $mysqli->query($sql);
                 if ($result){
                      echo "<script type='text/javascript'>  window.alert('test posted successfully!')      
