...
#heading{
    padding-left: 15px;
        font-size: 50px;
        font-family:"Futura","Lucida Bright","impact","Verdana", "Geneva", "sans-serif";
        color: #F1C40F;
...
<div id="hi">
	...
	<div id="photo" class="ok">
		<img src="https://grieteee1317.files.wordpress.com/2014/11/griet.jpg" id="pic" alt='' />
	</div>
	<div id="top" class="ok">
		<h1 id="head2">
			College Address
		...
		<p id="text">
			Gokaraju Rangaraju Institute of Engineering &amp; Technology,<br /> Nizampet Road, Bachupally, Kukatpally,<br /> Hyderabad- 500090 Telangana,<br /> India.<br />
		</p>
		<p id="text">
			Phone:+91-040- 65864440, 65864441
		</p>
		<p id="text">
			Fax:040-23040860
		</p>
		<p id="text">
			Administration:- Dr K V S Raju,Senior Admin Offier
		</p>
	</div>
	<div id="middle" class="k">
		<p id="note">
			For Queries,Fill In Your Details
		</p>
		<form method="post" action="7.php" id="form">
			<input type="text" name="name" id="name" /><br />
                        <input type="text" name="email" id="name" /><br />
			<textarea rows="3" cols="60" id="names" name="message">
			</textarea><br /><input type="submit" name="submit" id="submit" />
		</form>
	</div>
    
	<div id="bottom" class="k">
		<h1 id="head3">
			Reach Out To Us At
		</h1>
		<table id="table">
			<tbody>
				<tr>
					...
					<td>
						 <a href="mailto:info@griet.com" title="Click to send us an email" id="last">info@griet.com</a>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						 <a href="tel:9966005859" title="Click to call us" id="last">9966005859</a>
					</td>
				</tr>
			</tbody>
		</table>
                ...
                <div class="row" id="footone">
                    <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3" style="height: 130px; padding-top: 30px;">
                        <div class="img-wrapper">
                            <img class="img-responsive image-center" src="photi/glogo.png" alt="logo" style="height:130px" />
                        </div><hr />
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3" id="foottwo" style=" margin-top:5px; min-height:1px;">
                        ...
                        <ul class="footer-nav-links list-unstyled">
                            <li>
                                <a href="about.html#cyber">Feautres</a>
                            </li>
                            <li>
                                <a href="index.html#industry">Help</a>
                            </li>
                            <li>
                                <a href="form.php#threat">Contact</a>
                            </li>
                            <li>
                                <a href="company.html#vulner">Device</a>
                            </li>
                            <li>
                                <a href="http://www.secureblog.net/">Blog</a>
                            </li>
                        </ul>
                    ...
                    <div id="foottwo" style="margin-top: 0px; margin:0px;">
                        <h4>
                           Gokaraju Rangaraju Institute of Engineering and Techology,
                        </h4> Survey No. 288, Nizampet-Bachupally Road,<br> Bachupally, Kukatpally, <br>Hyderabad, Telangana 500090<br /> 
                    </div>
                </div>
                <div class="row">
...
$message = $_POST["message"];
            $sql = "INSERT INTO contact_us (name,email,message)"
              ...
              $result = $mysqli->query($sql);
                 ...
                 if ($result){
                mail('jirrapradyumna@gmail.com','OEP','$msg');
    ...
    window.location.href='1.html';
                    ...
                    {
                  echo "<h1>sorry, query cant be sent now</h1>";
                }
