...
$query = "Select * from pdf_answers where id=1;";
$result = mysqli_query($mysqli, $query);
$row = $result->fetch_assoc();
$querys = "Select * from student where id=1;";
$results = mysqli_query($mysqli, $querys);
$rows = $results->fetch_assoc();
$queryz = "Select * from pdf_questions where id=1;";
...
<section style="display: block;">
	<div class="container">
		...
		<div class="row margin-top-20">
			 ...
			 <h3><?php echo $rows["name"] ?></h3> <h3><?php echo $rowz["test_no"] ?></h3> 
        <form action="34point5.php" method="post" >
            <h3> 1:<?php echo $rowz["question_1"] ?> </h3> 
            <p>ANS:- <?php echo $row["ans_1"] ?>
            </p>  <p> 10 </p>  marks:-<input type="number" name="o1" required>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $one = $_POST["o1"];
    $reply = $one; 
    $qur = "UPDATE pdf_answers SET score='$reply' WHERE test_no=1 ";
