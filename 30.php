...
<section style="display: block;">
	<div class="container">
		...
		<div class="row margin-top-20">
            ...
            Question1<input type="text" name="q1" required><br>
            option1<input type="text" name="q1a1" required>
            option2<input type="text" name="q1a2" required>
            option3<input type="text" name="q1a3" required>
            option4<input type="text" name="q1a4" required>
            answer<input type="text" name="qa1r" required><br>

            Question1<input type="text" name="q2" required><br>
            option1<input type="text" name="q2a1" required>
            option2<input type="text" name="q2a2" required>
            option3<input type="text" name="q2a3" required>
            option4<input type="text" name="q2a4" required>
            answer<input type="text" name="qa2r" required><br>

            Question1<input type="text" name="q3" required><br>
            option1<input type="text" name="q3a1" required>
            option2<input type="text" name="q3a2" required>
            option3<input type="text" name="q3a3" required>
            option4<input type="text" name="q3a4" required>
            answer<input type="text" name="qa3r" required><br>

            Question1<input type="text" name="q4" required><br>
            option1<input type="text" name="q4a1" required>
            option2<input type="text" name="q4a2" required>
            option3<input type="text" name="q4a3" required>
            option4<input type="text" name="q4a4" required>
            answer<input type="text" name="qa4r" required><br>

            Question1<input type="text" name="q5" required><br>
            option1<input type="text" name="q5a1" required>
            option2<input type="text" name="q5a2" required>
            option3<input type="text" name="q5a3" required>
            option4<input type="text" name="q5a4" required>
            answer<input type="text" name="qa5r" required><br>

            Question1<input type="text" name="q6" required><br>
            option1<input type="text" name="q6a1" required>
            option2<input type="text" name="q6a2" required>
            option3<input type="text" name="q6a3" required>
            option4<input type="text" name="q6a4" required>
            answer<input type="text" name="qa6r" required><br>

            Question1<input type="text" name="q7" required><br>
            option1<input type="text" name="q7a1" required>
            option2<input type="text" name="q7a2" required>
            option3<input type="text" name="q7a3" required>
            option4<input type="text" name="q7a4" required>
            answer<input type="text" name="qa7r" required><br>

            Question1<input type="text" name="q8" required><br>
            option1<input type="text" name="q8a1" required>
            option2<input type="text" name="q8a2" required>
            option3<input type="text" name="q8a3" required>
            option4<input type="text" name="q8a4" required>
            answer<input type="text" name="qa8r" required><br>

            Question1<input type="text" name="q9" required><br>
            option1<input type="text" name="q9a1" required>
            option2<input type="text" name="q9a2" required>
            option3<input type="text" name="q9a3" required>
            option4<input type="text" name="q9a4" required>
            answer<input type="text" name="qa9r" required><br>

            Question1<input type="text" name="q10" required><br>
            option1<input type="text" name="q10a1" required>
            option2<input type="text" name="q10a2" required>
            option3<input type="text" name="q10a3" required>
            option4<input type="text" name="q10a4" required>
            answer<input type="text" name="qa10r" required><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $i1 = "INSERT INTO quiz_questions (id,type,subject,branch,section,test_no,assignment_no,q1,q1a1,q1a2,q1a3,q1a4,a1,q2,q2a1,q2a2,q2a3,q2a4,a2,q3,q3a1,q3a2,q3a3,q3a4,a3,q4,q4a1,q4a2,q4a3,q4a4,a4,q5,q5a1,q5a2,q5a3,q5a4,a5,q6,q6a1,q6a2,q6a3,q6a4,a6,q7,q7a1,q7a2,q7a3,q7a4,a7,q8,q8a1,q8a2,q8a3,q8a4,a8,q9,q9a1,q9a2,q9a3,q9a4,a9,q10,q10a1,q10a2,q10a3,q10a4,a10)"
            . "VALUES ('$facultyid','quiz','$subject','cse','b',2,1,'$q1','$q1a1','$q1a2','$q1a3','$q1a4','$qa1r','$q2','$q2a1','$q2a2','$q2a3','$q2a4','$qa2r','$q3','$q3a1','$q3a2','$q3a3','$q3a4','$qa3r','$q4','$q4a1','$q4a2','$q4a3','$q4a4','$qa4r','$q5','$q5a1','$q5a2','$q5a3','$q5a4','$qa5r','$q6','$q6a1','$q6a2','$q6a3','$q6a4','$qa6r','$q7','$q7a1','$q7a2','$q7a3','$q7a4','$qa7r','$q8','$q8a1','$q8a2','$q8a3','$q8a4','$qa8r','$q9','$q9a1','$q9a2','$q9a3','$q9a4','$qa9r','$q10','$q10a1','$q10a2','$q10a3','$q10a4','$qa10r')";

    $r1 = $mysqli->query($i1);

    if ($r1) {
        echo "<script type='text/javascript'>  window.alert('quiz test posted successfully!')      
 document.location = '25.php'; </script>";
    } else {
        echo "<h1>quiz cant be posted</h1>";
    }
